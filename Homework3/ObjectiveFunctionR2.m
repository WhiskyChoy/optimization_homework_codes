classdef ObjectiveFunctionR2 < ObjectiveFunction
    ...
    methods
        ...
        function self = ObjectiveFunctionR2(obj_func_exp, show_msg)

            arguments
                obj_func_exp (1, 1) sym {quadratic_check} = Util.get_target_func_exp()
        ...
        function res = f(self, x)
            res = self.obj.f(x(1), x(2));
        end
        ...
        function res = g(self, x)
            res = self.obj.g(x(1), x(2));
        end

        function res = h(self, x)
            res = self.obj.h(x(1), x(2));
        end
